...
export const Route = createFileRoute("/categorie")({
  head: () => ({
    meta: [
      { title: "Collezioni di Gioielli Fatti a Mano · Cara Preziosi Bari" },
      {
        name: "description",
        content:
          "Scopri le collezioni di gioielli fatti a mano Cara Preziosi: anelli, orecchini, collane e bracciali realizzati a mano nel laboratorio orafo di Bari.",
      },
      { property: "og:title", content: "Collezioni di Gioielli Fatti a Mano · Cara Preziosi Bari" },
      {
      ...
      { name: "twitter:title", content: "Collezioni di Gioielli Fatti a Mano · Cara Preziosi Bari" },
      {
