...
import catAnelliAsset from "@/assets/cara/cat-anelli.jpg.asset.json";
import catOrecchiniAsset from "@/assets/cara/cat-orecchini.jpg.asset.json";
import catCollaneAsset from "@/assets/cara/cat-collane.jpg.asset.json";
const catAnelli = catAnelliAsset.url;
const catOrecchini = catOrecchiniAsset.url;
const catCollane = catCollaneAsset.url;
